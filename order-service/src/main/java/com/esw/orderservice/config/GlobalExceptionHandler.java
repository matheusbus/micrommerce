package com.esw.orderservice.config;

import com.esw.orderservice.exception.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleOrderCancellationNotAllowed(OrderCancellationNotAllowedException ex) {
